        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <input disabled={isGuestInputOpen} type="text" placeholder="Para onde você vair?" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1"/>
            </div>
                ...
                {emailsToInvite.map(email => {
                  return (
                    <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                      ...
                      <button type="buton" onClick={() => removeEmailFromInvites(email)} >
